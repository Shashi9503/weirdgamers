...
<body>
    ...
    <script>
        ...
        // document.querySelector("div.text-center").lastElementChild.addEventListener("click",()=>{
        //     login_button.disabled=true;
        //     email.classList.remove("error");
        //     pwd.classList.remove("error");
        //     pwd.nextElementSibling.innerText="";
        //     email.nextElementSibling.innerText="";
        //     login_button.previousElementSibling.style.display="none";
        ...
        //     }
        //     a=new XMLHttpRequest();
        //     a.open("POST","forgot_pwd_back.php",true);
        //     a.setRequestHeader("content-type","application/x-www-form-urlencoded");
        ...
        //                 login_button.disabled=false;
        //             }
        //             else if(a.responseText=="Email not registered")
        //             {
        //                 email.nextElementSibling.innerText=a.responseText;
        //                 email.classList.add("error");
        //                 email.focus();
        ...
        //             }
        //             else
        //                 window.location.href="forgot_pwd1.php";
        //         }
        //     };
        // })
    </script>
