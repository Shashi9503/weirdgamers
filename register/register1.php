...
<body>
            ...
            <div class="card">
                ...
                <div class="card-img-overlay text-white col-10 col-lg-6 mx-auto">
                    ...
                    <div class="text-center">
                        <p class="mb-0">A verification code sent on your email id. Please enter code here.</p>
    ...
    <script>
        ...
        function r(e)
        {
            ...
            a.open("POST","register_back1.php",true);
        ...
        resend.addEventListener("click",()=>{
            sub.disabled=true;
            a=new XMLHttpRequest();
            a.open("GET","register_back1a.php",true);
            a.send(null);
            a.onreadystatechange=()=>{
                if(a.readyState==4)
                {
                    ...
                    {
                        p.innerText="Verification code sent. Please Enter here.";
                        code.value="";
                        code.focus();             
                    }
