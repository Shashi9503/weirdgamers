<?php
    ...
    if($q->execute(array(':id'=>$_SESSION['login_email'])))
    {
        ...
        $str="INSERT INTO pre_payment (date_time,game,name,leader_id,phone,un_1,un_2,un_3,un_4) VALUES (:d,:g,:n,:e,:p,:u1,:u2,:u3,:u4)";
        $q=$pdo->prepare($str);
        if( $q->execute( array( ':d'=>date('Y-m-d H:i:s', time()),':g'=>$_POST['game'],':n'=>$row['name'],':e'=>$_SESSION['login_email'],':p'=>$row['phone'],':u1'=>$_POST['un_1'],':u2'=>isset($_POST['un_2'])?$_POST['un_2']:"",':u3'=>isset($_POST['un_3'])?$_POST['un_3']:"",':u4'=>isset($_POST['un_4'])?$_POST['un_4']:"" ) ) )
            echo "1";
        else
