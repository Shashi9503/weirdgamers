...
<html lang="en">
    ...
    <head>
        ...
        <title>Weirdgamers</title>
         ...
         <!--CSS -->
        <!--<link rel="preload" as="font" href="/assets/css/Forte.woff2" type="font/woff2" crossorigin="anonymous">-->
    ...
    <body>
			...
			<div class="content">
                ...
                <div class="container" style="margin-top: 40px;" id="stats">
					...
					<div class="row">
						<div class="col-sm-3">
							<br>
							<img alt="group" src="img/group.webp"/>
							<h4>1,000+ Players</h4><br>
						</div>
						<div class="col-sm-3">
							<br>
							<img alt="review" src="img/review.webp"/>
							<h4>4.5 User Rating</h4><br>
						</div>
						<div class="col-sm-3">
							<br>
							<img alt="game" src="img/gameplay.webp"/>
							<h4>100+ Tournaments</h4><br>
						</div>
						<div class="col-sm-3">
							<br>
							<img alt="rupee" src="img/rupee.webp"/>
		...
		<script async src="assets/js/jquery-migrate-3.0.0.min.js"></script>
		<script async src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js" integrity="sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1" crossorigin="anonymous"></script>
		<script async src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
        <script async src="assets/js/jquery.backstretch.min.js"></script>
        <script async src="assets/js/wow.min.js"></script>
        <script async src="assets/js/jquery.waypoints.min.js"></script>
        <script async src="assets/js/jquery.mCustomScrollbar.concat.min.js"></script>
